    ...
    function buildTree(rootStack$jscomp$0, readHookLog) {
      for (
          ...
          for (
            ...
            (rootStack = []),
              ...
              (hookStack = {
                ...
                hookSource: {
                  lineNumber:
                    void 0 === hookStack.lineNumber
                      ? null
                      : hookStack.lineNumber,
                  columnNumber:
                    void 0 === hookStack.columnNumber
                      ? null
                      : hookStack.columnNumber,
                  functionName:
                    void 0 === hookStack.functionName
                      ? null
                      : hookStack.functionName,
                  fileName:
                    void 0 === hookStack.fileName ? null : hookStack.fileName
                }
              }),
        ...
        parseResult &&
          ...
          (hook$jscomp$0.lineNumber =
            void 0 === parseResult.lineNumber ? null : parseResult.lineNumber),
          (hook$jscomp$0.functionName =
            void 0 === parseResult.functionName
              ? null
              : parseResult.functionName),
          (hook$jscomp$0.fileName =
            void 0 === parseResult.fileName ? null : parseResult.fileName),
          (hook$jscomp$0.columnNumber =
            void 0 === parseResult.columnNumber
              ? null
              : parseResult.columnNumber));
