  ...
  (function () {
    ...
    function commitMutationEffectsOnFiber(finishedWork, root) {
      ...
      switch (finishedWork.tag) {
        ...
        case 22:
          ...
          offscreenSubtreeIsHidden =
            prevOffscreenSubtreeIsHidden || newHiddenCallbacks;
          offscreenSubtreeWasHidden =
          ...
          if (flags & 8192)
            a: for (
              root = finishedWork.stateNode,
                root._visibility = newHiddenCallbacks
    ...
    function commitRoot(
      ...
      if (null !== finishedWork) {
        ...
        error = completedRenderStartTime |= concurrentlyUpdatedLanes;
        didIncludeRenderPhaseUpdate = root.pendingLanes;
        root.pendingLanes = error;
        root.suspendedLanes = 0;
        root.pingedLanes = 0;
        root.warmLanes = 0;
        root.expiredLanes &= error;
        root.entangledLanes &= error;
        root.errorRecoveryDisabledLanes &= error;
        root.shellSuspendCounter = 0;
        exitStatus = root.entanglements;
        suspendedState = root.expirationTimes;
        i = root.hiddenUpdates;
        for (error = didIncludeRenderPhaseUpdate & ~error; 0 < error; ) {
          var index = 31 - clz32(error),
            lane = 1 << index;
          exitStatus[index] = 0;
          suspendedState[index] = -1;
          var hiddenUpdatesForLane = i[index];
        ...
        0 !== suspendedRetryLanes &&
          ...
          0 !== root.tag &&
          (root.suspendedLanes |=
            suspendedRetryLanes & ~(didIncludeRenderPhaseUpdate & ~lanes));
        root === workInProgressRoot &&
        ...
        pendingEffectsLanes = lanes;
        pendingEffectsRemainingLanes = completedRenderStartTime;
        ...
        null !== suspendedCommitReason &&
          ((root = commitStartTime),
          !supportsUserTiming ||
            root <= completedRenderEndTime ||
            (workInProgressUpdateTask
              ? workInProgressUpdateTask.run(
                  console.timeStamp.bind(
                    console,
        ...
        if (
          ...
          try {
            for (nextEffect = finishedWork; null !== nextEffect; ) {
              ...
              if (0 !== (finishedWork.subtreeFlags & 1028) && null !== child)
                (child.return = finishedWork), (nextEffect = child);
              else
                a: for (; null !== nextEffect; ) {
                  lanes = finishedWork = nextEffect;
                  var current = lanes.alternate,
                    flags = lanes.flags;
                  switch (lanes.tag) {
                    case 0:
                      if (0 !== (flags & 4)) {
                        var updateQueue = lanes.updateQueue,
                          eventPayloads =
                            null !== updateQueue ? updateQueue.events : null;
                        if (null !== eventPayloads)
                          for (
                            lanes = 0;
                            lanes < eventPayloads.length;
                            lanes++
                          ) {
                            var _eventPayloads$ii = eventPayloads[lanes];
                            _eventPayloads$ii.ref.impl =
                              _eventPayloads$ii.nextImpl;
                          }
                      }
                      break;
                    case 11:
                    ...
                    case 1:
                      0 !== (flags & 1024) &&
                        null !== current &&
                        commitClassSnapshot(lanes, current);
                      break;
                    case 3:
                      0 !== (flags & 1024) &&
                        lanes.stateNode.containerInfo.children.splice(0);
                      break;
                    case 5:
                    case 26:
                    case 27:
                  ...
                  var sibling = finishedWork.sibling;
                  if (null !== sibling) {
    ...
    function flushPendingEffects() {
      ...
      a: if (pendingEffectsStatus !== PENDING_PASSIVE_PHASE)
        ...
        try {
          ...
          commitErrors = null;
          var passiveEffectStartTime = now$1();
          if (pendingDelayedCommitReason === ANIMATION_STARTED_COMMIT) {
            var startTime = commitEndTime;
            !supportsUserTiming ||
              passiveEffectStartTime <= startTime ||
              (animatingTask
                ? animatingTask.run(
                    console.timeStamp.bind(
                      console,
          ...
          finishedWork$jscomp$0 = workInProgressUpdateTask;
          null !== commitErrors
            ? logCommitErrored(
                passiveEffectStartTime,
            ...
            : !supportsUserTiming ||
              passiveEffectsEndTime <= passiveEffectStartTime ||
              (finishedWork$jscomp$0
                ? finishedWork$jscomp$0.run(
                    console.timeStamp.bind(
                      console,
                      "Remaining Effects",
                      passiveEffectStartTime,
    ...
    (function () {
      var internals = {
        bundleType: 1,
        version: "19.2.4-canary-90ab3f89-20260126",
        rendererPackageName: "react-test-renderer",
        currentDispatcherRef: ReactSharedInternals,
        reconcilerVersion: "19.2.4-canary-90ab3f89-20260126"
      };
    ...
    exports.create = function (element, options) {
      !0 !== global.IS_REACT_NATIVE_TEST_ENVIRONMENT &&
        console.error(
          "react-test-renderer is deprecated. See https://react.dev/warnings/react-test-renderer"
        );
      var createNodeMock = JSCompiler_object_inline_createNodeMock_1380,
