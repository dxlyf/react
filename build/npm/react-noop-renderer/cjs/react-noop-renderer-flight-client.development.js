...
"production" !== process.env.NODE_ENV &&
  (function () {
    var flightModules = require("react-noop-renderer/flight-modules"),
      ...
      createStreamState = _ReactFlightClient.createStreamState,
    ...
    exports.read = function (source, options) {
      for (
        var response = createResponse(
            ...
            !0,
            void 0,
            void 0 !== options && void 0 !== options.debugChannel
              ? options.debugChannel.onMessage
              : void 0
          ),
          streamState = createStreamState(response, source),
          i = 0;
        i < source.length;
        i++
      )
        processBinaryChunk(response, streamState, source[i], 0);
      void 0 !== options && options.close && close(response);
