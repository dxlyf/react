...
"production" !== process.env.NODE_ENV &&
  (function () {
    ...
    exports.render = function (model, options) {
      var destination = [],
        request = ReactNoopFlightServer.createRequest(
          model,
          void 0,
        ...
        signal = options ? options.signal : void 0;
      if (signal)
        if (signal.aborted) ReactNoopFlightServer.abort(request, signal.reason);
        else {
      ...
      options &&
        ...
        (options.debugChannel.onMessage = function (message) {
