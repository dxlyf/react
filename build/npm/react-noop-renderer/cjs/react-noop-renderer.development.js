  ...
  (function () {
    ...
    ReactFiberReconciler = (function (reconciler, useMutation) {
      ...
      var instanceCounter = 0,
        ...
        sharedHostConfig = {
          rendererVersion: "19.2.4-canary-90ab3f89-20260126",
          ...
          cloneMutableTextInstance: function () {
            throw Error("Not yet implemented.");
          },
          createFragmentInstance: function () {
            return null;
          },
          updateFragmentInstanceFiber: function () {},
          commitNewChildToFragmentInstance: function () {},
          deleteChildFromFragmentInstance: function () {},
          ...
          maySuspendCommitOnUpdate: function (type, oldProps, newProps) {
            return (
              "suspensey-thing" === type &&
              "string" === typeof newProps.src &&
          ...
          maySuspendCommitInSyncRender: function () {
            return !0;
          },
          ...
          preloadInstance: function (instance, type, props) {
            ...
            instance = suspenseyThingCache.get(props.src);
          ...
          suspendInstance: function (state, instance, type, props) {
            instance = props.src;
            if ("suspensey-thing" === type && "string" === typeof instance) {
              type = suspenseyThingCache.get(instance);
              if (void 0 === type)
          ...
          suspendOnActiveViewTransition: function () {},
          waitForCommitToBeReady: function (state) {
            return 0 < state.pendingCount
              ? function (commit) {
                  state.commit = commit;
                  return function () {
                    state.commit = null;
          ...
          getSuspendedCommitReason: function () {
            return null;
          },
      ...
      sharedHostConfig = useMutation
        ? assign({}, sharedHostConfig, {
            ...
            applyViewTransitionName: function () {},
            restoreViewTransitionName: function () {},
            cancelViewTransitionName: function () {},
            cancelRootViewTransitionName: function () {},
            restoreRootViewTransitionName: function () {},
            cloneRootViewTransitionContainer: function () {
              throw Error("Not yet implemented.");
            },
            removeRootViewTransitionClone: function () {
              throw Error("Not implemented.");
            },
            measureInstance: function () {
              return null;
            },
            measureClonedInstance: function () {
              return null;
            },
            wasInstanceInViewport: function () {
              return !0;
            },
            hasInstanceChanged: function () {
              return !1;
            },
            hasInstanceAffectedParent: function () {
              return !1;
            },
            ...
            startGestureTransition: function (
              rootContainer,
              timeline,
              rangeStart,
              rangeEnd,
            ...
            stopViewTransition: function () {},
            createViewTransitionInstance: function () {
              return null;
            },
            getCurrentGestureOffset: function () {
              return 0;
            },
      ...
      return ReactNoop;
    })(ReactFiberReconciler.default, !0);
