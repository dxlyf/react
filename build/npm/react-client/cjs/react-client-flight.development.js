  ...
  ((module.exports = function ($$$config) {
    ...
    function resolveModuleChunk(response, chunk, value) {
      if ("pending" === chunk.status || "blocked" === chunk.status) {
        ...
        chunk.value = value;
        chunk.reason = null;
        value = getModuleDebugInfo(value);
    ...
    var React = require("react"),
      ...
      getModuleDebugInfo = $$$config.getModuleDebugInfo,
    ...
    exports.createStreamState = function (weakResponse, streamDebugValue) {
      var streamState = {
        _rowState: 0,
        _rowID: 0,
        _rowTag: 0,
      ...
      if (void 0 !== weakResponse.weak.deref()) {
        ...
        for (
          ...
          if (-1 < lastIdx) {
            ...
            processFullStringRow(weakResponse, streamState, rowID, rowTag, i);
            i = lastIdx;
            3 === rowState && i++;
